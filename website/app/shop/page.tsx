...
const PRODUCTS: Product[] = [
  ...
  { id: 'p6', name: 'Oversized Linen Shirt', brand: 'Noma', price: 95, rating: 4.4, reviewCount: 211, category: 'tops', colors: ['white', 'sky', 'sand'], sizes: ['S', 'M', 'L', 'XL'], description: 'Relaxed-fit linen button-up for warm days', occasion: ['casual', 'weekend'], style: ['minimalist', 'boho'], gradient: 'linear-gradient(135deg, #e8e4e0 0%, #d4cfc9 50%, #bfb8ae 100%)', emoji: '🤍' },
